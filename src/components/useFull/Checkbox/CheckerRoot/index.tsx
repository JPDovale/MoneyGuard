...
const checkerRootStyles = cva(
  ...
  ],
  {
    variants: {
      theme: {
        dark: [
          'bg-gray300 data-[state=checked]:bg-green-600 shadow-defaultDark focus:shadow-inFocusDark',
        ],
        light: [
          'bg-gray700 data-[state=checked]:bg-green-900 shadow-default focus:shadow-inFocus ',
        ],
      },
    },
  },
